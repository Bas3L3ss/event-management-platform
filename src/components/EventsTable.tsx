...
export const columns: ColumnDef<Event>[] = [
  ...
  },
  {
    ...
    header: "clerkId",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("clerkId")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("eventImg")}</div>
    ),
  },
  //   {
  //     accessorKey: "amount",
  ...
  //   },
  {
    ...
    cell: ({ row }) => {
      ...
      const clerkId = row.getValue("clerkId");
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>
              <Link href={`/profile/${clerkId}`}>Contact Host</Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          ...
          {table.getFilteredRowModel().rows.length} events(s).
        </div>
